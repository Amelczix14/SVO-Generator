...
def generate_sentence():
    ...
    # Call the functions for conjugation and sentence construction
    sentence = construct_sentence(subject, verb, determiner, complement, number, tense)
    sentence = sentence.capitalize()

    return jsonify({'sentence': sentence})


def construct_sentence(subject, verb, determiner, complement, number, tense):
    sentence = (f"{determiner if determiner else ''} {subject} "
